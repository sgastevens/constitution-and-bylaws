...
\begin{enumerate}
    ...
    \item A Senator must attend at least five SGA-funded events per semester, provided that those events fall in at least three different months during that semester. Senators must also
attend at least one Oversight Committee approved administrative outreach event per semester. The Senator must report about each event via the Accountability Form within 72 hours of the event start time.
...
Every bill shall be subjected to one reading before it may be approved. The approval of a bill
shall not occur in the same meeting as the first reading.
\begin{enumerate} 
    \item First Reading 
\end{enumerate}
The first reading is when a bill is introduced to the Senate. The first reading shall occur by adopting a motion to read a bill. The motion to read a bill shall be stated as “I move to read
[“bill”].” The motion to read a bill shall have the following characteristics:
\begin{enumerate}
...
\end{enumerate}
Upon adoption of the motion to read a bill, (a) the bill is considered read, and (b) the Secretary
shall place a motion to approve the bill on the agenda for the following meeting of the Senate.
...
The Committee shall  assist the Secretary in archiving the constitutions and bylaws of RSOs, and the Constitution, bylaws, and addendums of the Student Government Association. The Rules Committee Chair may make non-substantive
