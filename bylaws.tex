...
deliver a petition with signatures from five percent of their class year to 
...
\section{The Entertainment Committee}

\subsection{Purpose}
The purpose of the Entertainment Committee, herein referred to as ``EC'', is 
to plan and coordinate campus-wide entertainment events that are geared toward 
the interests of the Student Body.

\subsection{Executive Board}
The Executive Board of EC shall be comprised of Primary Officers and Event 
Officers.
\begin{enumerate}
    \item The Primary Officers shall be comprised of: 
        \begin{enumerate}
            \item The President
            \item The Vice President of On-Campus Events
            \item The Vice President of Off-Campus Events
            \item The Vice President of Communications
        \end{enumerate}
    \item The Event Officers shall be defined the in the Bylaws of EC.
\end{enumerate}
The responsibilities of all Executive Board members shall be defined in the 
bylaws of the EC. At least one Executive Board officer must be responsible for 
acting as a liaison to the SGA by attending Senate meetings and giving a 
simple report on activities when compelled by the SGA.

\subsection{Allocation}
EC shall be guaranteed an allocation of a minimum of sixteen percent of the 
total student activity fees per semester. This allocation shall only be 
guaranteed when a budget for the semester, from the EC, is received by the 
SGA.
